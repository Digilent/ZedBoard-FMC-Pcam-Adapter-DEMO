...
* Vivado 2020.1 Installation with Xilinx Vitis IDE: To set up Vivado, see the Installing Vivado and Digilent Board Files Tutorial.

Demo Setup
----------

1. Download the most recent release ZIP archive ("FMC-Pcam-Adapter-2020.1-*.zip") from the repo's [releases page](https://github.com/Digilent/ZedBoard-FMC-Pcam-Adapter-DEMO/releases).
2. Extract the downloaded ZIP.
3. Open the XPR project file, found at \<archive extracted location\>/hw/proj/ZedBoard-FMC-Pcam-Adapter-DEMO.xpr, included in the extracted release archive in Vivado 2020.1.
...
6. In the toolbar at the top of the Vivado window, select **Tools -> Launch Vitis IDE**. Select \<archive extracted location\>/sw/src/ as both the workspace location and exported location, then click **OK**.
7. With Vitis IDE opened, wait for the hardware platform exported by Vivado to be imported.
8. In the toolbar at the top of the Vitis IDE window, select **File -> New -> Application Project**.
...
12. In the Project Explorer panel to the left of the Vitis IDE window, expand the new application project (named "ZedBoard_FMC_Pcam_Adapter_DEMO").
...
| Setting                                                | Value                                                                     |
| -                                                      | -                                                                         |
| From directory                                         | \<archive extracted location\>/sw/src  |
...
20. In the toolbar at the top of the Vitis IDE window, select **Xilinx -> Program FPGA**. Leave all fields as their defaults and click "Program".
