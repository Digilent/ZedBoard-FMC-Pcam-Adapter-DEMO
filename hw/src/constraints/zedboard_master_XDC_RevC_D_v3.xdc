...
# VGA Output - Bank 33
# ---------------------------------------------------------------------------- 
set_property -dict {PACKAGE_PIN Y21 IOSTANDARD LVCMOS33} [get_ports {vga_pBlue[0]}];  # "VGA-B1"
set_property -dict {PACKAGE_PIN Y20 IOSTANDARD LVCMOS33} [get_ports {vga_pBlue[1]}];  # "VGA-B2"
set_property -dict {PACKAGE_PIN AB20 IOSTANDARD LVCMOS33} [get_ports {vga_pBlue[2]}];  # "VGA-B3"
set_property -dict {PACKAGE_PIN AB19 IOSTANDARD LVCMOS33} [get_ports {vga_pBlue[3]}];  # "VGA-B4"
set_property -dict {PACKAGE_PIN AB22 IOSTANDARD LVCMOS33} [get_ports {vga_pGreen[0]}];  # "VGA-G1"
set_property -dict {PACKAGE_PIN AA22 IOSTANDARD LVCMOS33} [get_ports {vga_pGreen[1]}];  # "VGA-G2"
set_property -dict {PACKAGE_PIN AB21 IOSTANDARD LVCMOS33} [get_ports {vga_pGreen[2]}];  # "VGA-G3"
set_property -dict {PACKAGE_PIN AA21 IOSTANDARD LVCMOS33} [get_ports {vga_pGreen[3]}];  # "VGA-G4"
set_property -dict {PACKAGE_PIN AA19 IOSTANDARD LVCMOS33} [get_ports {vga_pHSync}];  # "VGA-HS"
set_property -dict {PACKAGE_PIN V20 IOSTANDARD LVCMOS33} [get_ports {vga_pRed[0]}];  # "VGA-R1"
set_property -dict {PACKAGE_PIN U20 IOSTANDARD LVCMOS33} [get_ports {vga_pRed[1]}];  # "VGA-R2"
set_property -dict {PACKAGE_PIN V19 IOSTANDARD LVCMOS33} [get_ports {vga_pRed[2]}];  # "VGA-R3"
set_property -dict {PACKAGE_PIN V18 IOSTANDARD LVCMOS33} [get_ports {vga_pRed[3]}];  # "VGA-R4"
set_property -dict {PACKAGE_PIN Y19 IOSTANDARD LVCMOS33} [get_ports {vga_pVSync}];  # "VGA-VS"
...
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN AB14 [get_ports {cam_pwup_tri_io[1]}];  # "FMC-PRSNT"
...
set_property -dict {PACKAGE_PIN M20 IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports {dphy_b_hs_clock_clk_n}];  # "FMC-LA00_CC_N"
set_property -dict {PACKAGE_PIN M19 IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports {dphy_b_hs_clock_clk_p}];  # "FMC-LA00_CC_P"
set_property -dict {PACKAGE_PIN N20 IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports {dphy_a_hs_clock_clk_n}];  # "FMC-LA01_CC_N"
set_property -dict {PACKAGE_PIN N19 IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports {dphy_a_hs_clock_clk_p}];  # "FMC-LA01_CC_P" - corrected 6/6/16 GE
set_property -dict {PACKAGE_PIN P18 IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports {dphy_b_data_hs_n[0]}];  # "FMC-LA02_N"
set_property -dict {PACKAGE_PIN P17 IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports {dphy_b_data_hs_p[0]}];  # "FMC-LA02_P"
set_property -dict {PACKAGE_PIN P22 IOSTANDARD LVCMOS25} [get_ports {dphy_a_data_lp_n[0]}];  # "FMC-LA03_N"
set_property -dict {PACKAGE_PIN N22 IOSTANDARD LVCMOS25} [get_ports {dphy_a_data_lp_p[0]}];  # "FMC-LA03_P"
set_property -dict {PACKAGE_PIN M22 IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports {dphy_b_data_hs_n[1]}];  # "FMC-LA04_N"
set_property -dict {PACKAGE_PIN M21 IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports {dphy_b_data_hs_p[1]}];  # "FMC-LA04_P"
set_property -dict {PACKAGE_PIN K18 IOSTANDARD LVCMOS25} [get_ports {dphy_b_data_lp_n[1]}];  # "FMC-LA05_N"
set_property -dict {PACKAGE_PIN J18 IOSTANDARD LVCMOS25} [get_ports {dphy_b_data_lp_p[1]}];  # "FMC-LA05_P"
set_property -dict {PACKAGE_PIN L22 IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports {dphy_a_data_hs_n[1]}];  # "FMC-LA06_N"
set_property -dict {PACKAGE_PIN L21 IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports {dphy_a_data_hs_p[1]}];  # "FMC-LA06_P"
...
set_property -dict {PACKAGE_PIN J22 IOSTANDARD LVCMOS25} [get_ports {dphy_a_clk_lp_n}];  # "FMC-LA08_N"
set_property -dict {PACKAGE_PIN J21 IOSTANDARD LVCMOS25} [get_ports {dphy_a_clk_lp_p}];  # "FMC-LA08_P"
set_property -dict {PACKAGE_PIN R21 IOSTANDARD LVCMOS25} [get_ports {dphy_b_clk_lp_n}];  # "FMC-LA09_N"
set_property -dict {PACKAGE_PIN R20 IOSTANDARD LVCMOS25} [get_ports {dphy_b_clk_lp_p}];  # "FMC-LA09_P"
set_property -dict {PACKAGE_PIN T19 IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports {dphy_a_data_hs_n[0]}];  # "FMC-LA10_N"
set_property -dict {PACKAGE_PIN R19 IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports {dphy_a_data_hs_p[0]}];  # "FMC-LA10_P"
#set_property PACKAGE_PIN N18 [get_ports {FMC_LA11_N}];  # "FMC-LA11_N"
#set_property PACKAGE_PIN N17 [get_ports {FMC_LA11_P}];  # "FMC-LA11_P"
set_property -dict {PACKAGE_PIN P21 IOSTANDARD LVCMOS25} [get_ports {dphy_a_data_lp_n[1]}];  # "FMC-LA12_N"
set_property -dict {PACKAGE_PIN P20 IOSTANDARD LVCMOS25} [get_ports {dphy_a_data_lp_p[1]}];  # "FMC-LA12_P"
set_property -dict {PACKAGE_PIN M17 IOSTANDARD LVCMOS25} [get_ports {dphy_b_data_lp_n[0]}];  # "FMC-LA13_N"
set_property -dict {PACKAGE_PIN L17 IOSTANDARD LVCMOS25} [get_ports {dphy_b_data_lp_p[0]}];  # "FMC-LA13_P"
...
set_property -dict {PACKAGE_PIN B20 IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports {dphy_c_hs_clock_clk_n}];  # "FMC-LA17_CC_N"
set_property -dict {PACKAGE_PIN B19 IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports {dphy_c_hs_clock_clk_p}];  # "FMC-LA17_CC_P"
set_property -dict {PACKAGE_PIN C20 IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports {dphy_d_hs_clock_clk_n}];  # "FMC-LA18_CC_N"
set_property -dict {PACKAGE_PIN D20 IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports {dphy_d_hs_clock_clk_p}];  # "FMC-LA18_CC_P"
set_property -dict {PACKAGE_PIN G16 IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports {dphy_c_data_hs_n[1]}];  # "FMC-LA19_N"
set_property -dict {PACKAGE_PIN G15 IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports {dphy_c_data_hs_p[1]}];  # "FMC-LA19_P"
set_property -dict {PACKAGE_PIN G21 IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports {dphy_c_data_hs_n[0]}];  # "FMC-LA20_N"
set_property -dict {PACKAGE_PIN G20 IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports {dphy_c_data_hs_p[0]}];  # "FMC-LA20_P"
set_property -dict {PACKAGE_PIN E20 IOSTANDARD LVCMOS25} [get_ports {dphy_d_clk_lp_n}];  # "FMC-LA21_N"
set_property -dict {PACKAGE_PIN E19 IOSTANDARD LVCMOS25} [get_ports {dphy_d_clk_lp_p}];  # "FMC-LA21_P"
set_property -dict {PACKAGE_PIN F19 IOSTANDARD LVCMOS25} [get_ports {dphy_c_clk_lp_n}];  # "FMC-LA22_N"
set_property -dict {PACKAGE_PIN G19 IOSTANDARD LVCMOS25} [get_ports {dphy_c_clk_lp_p}];  # "FMC-LA22_P"
set_property -dict {PACKAGE_PIN D15 IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports {dphy_d_data_hs_n[0]}];  # "FMC-LA23_N"
set_property -dict {PACKAGE_PIN E15 IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports {dphy_d_data_hs_p[0]}];  # "FMC-LA23_P"
set_property -dict {PACKAGE_PIN A19 IOSTANDARD LVCMOS25} [get_ports {dphy_c_data_lp_n[1]}];  # "FMC-LA24_N"
set_property -dict {PACKAGE_PIN A18 IOSTANDARD LVCMOS25} [get_ports {dphy_c_data_lp_p[1]}];  # "FMC-LA24_P"
set_property -dict {PACKAGE_PIN C22 IOSTANDARD LVCMOS25} [get_ports {dphy_c_data_lp_n[0]}];  # "FMC-LA25_N"
set_property -dict {PACKAGE_PIN D22 IOSTANDARD LVCMOS25} [get_ports {dphy_c_data_lp_p[0]}];  # "FMC-LA25_P"
set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVCMOS25} [get_ports {dphy_d_data_lp_n[0]}];  # "FMC-LA26_N"
set_property -dict {PACKAGE_PIN F18 IOSTANDARD LVCMOS25} [get_ports {dphy_d_data_lp_p[0]}];  # "FMC-LA26_P"
set_property -dict {PACKAGE_PIN D21 IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports {dphy_d_data_hs_n[1]}];  # "FMC-LA27_N"
set_property -dict {PACKAGE_PIN E21 IOSTANDARD LVDS_25 DIFF_TERM true} [get_ports {dphy_d_data_hs_p[1]}];  # "FMC-LA27_P"
set_property -dict {PACKAGE_PIN A17 IOSTANDARD LVCMOS25} [get_ports {dphy_d_data_lp_n[1]}];  # "FMC-LA28_N"
set_property -dict {PACKAGE_PIN A16 IOSTANDARD LVCMOS25} [get_ports {dphy_d_data_lp_p[1]}];  # "FMC-LA28_P"
