...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = AXI_GammaCorrection_A
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = AXI_GammaCorrection_B
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = AXI_GammaCorrection_C
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = AXI_GammaCorrection_D
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = MIPI_CSI_2_RX
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = MIPI_CSI_2_RX_A
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = MIPI_CSI_2_RX
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = MIPI_CSI_2_RX_B
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = MIPI_CSI_2_RX
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = MIPI_CSI_2_RX_C
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = MIPI_CSI_2_RX
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = MIPI_CSI_2_RX_D
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = MIPI_D_PHY_RX
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = MIPI_D_PHY_RX_A
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = MIPI_D_PHY_RX
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = MIPI_D_PHY_RX_B
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = MIPI_D_PHY_RX
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = MIPI_D_PHY_RX_C
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = MIPI_D_PHY_RX
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = MIPI_D_PHY_RX_D
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = axivdma
 PARAMETER DRIVER_VER = 6.5
 PARAMETER HW_INSTANCE = axi_vdma_b
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axivdma
 PARAMETER DRIVER_VER = 6.5
 PARAMETER HW_INSTANCE = axi_vdma_c
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axivdma
 PARAMETER DRIVER_VER = 6.5
 PARAMETER HW_INSTANCE = axi_vdma_d
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = video_scaler
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = video_scaler_a
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = video_scaler
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = video_scaler_b
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = video_scaler
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = video_scaler_c
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = video_scaler
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = video_scaler_d
END
