...
set proj_name "fmc-pcam-adapter"
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part $part -flow {Vivado Implementation 2018} -strategy "Performance_ExplorePostRoutePhysOpt" -constrset constrs_1 -parent_run synth_1
} else {
...
set sdk_list [lsearch -inline -all -not -exact $sdk_list "$sdk_dir/.keep"]
if {[llength $sdk_list] != 0} {
	exec xsct -eval "setws -switch $sdk_dir; importproject $sdk_dir"
}
# 
# 
